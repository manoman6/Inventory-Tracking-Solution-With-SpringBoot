...
import com.example.demo.validators.ValidMaxEntry;
import com.example.demo.validators.ValidMinEntry;
...
public abstract class Part implements Serializable {
    ...
    Integer inv;
    @Min(value = 0, message = "Below the minimum inventory")
    ...
    public boolean isInventoryValid(int minInv, int maxInv){
